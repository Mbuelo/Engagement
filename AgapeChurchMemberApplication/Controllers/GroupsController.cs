...
namespace AgapeChurchMemberApplication.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "GroupId,GroupName,GroupDetails")] Group group)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "GroupId,GroupName,GroupDetails")] Group group)
        {
            if (ModelState.IsValid)
            {
